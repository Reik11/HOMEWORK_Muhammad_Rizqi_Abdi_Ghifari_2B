...
# Stok awal
stok = [
    {"nama": "Keyboard", "jumlah": 10},
    {"nama": "Mouse", "jumlah": 50},
    {"nama": "Laptop", "jumlah": 30},
]
...
def main():
    while True:
        ...
        if pilihan == "1":
            nama_benda = input("Masukkan nama barang: ")
            jumlah_benda = int(input("Masukkan jumlah barang: "))
            databarang.tambah_data_barang(stok, nama_benda, jumlah_benda)
